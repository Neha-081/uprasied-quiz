      ...
      <div className="rounded-t-[30px] bg-white p-5 h-full">
        ...
        <div className="flex flex-col items-center pt-8">
          ...
          >
            ...
            <p className="truncate"><span className="font-bold text-base"> {score} </span> Correct</p>
          </div>
        </div>
        <div
          ...
          >
            ...
            <p className="truncate"><span className="font-bold text-base"> {totalQuestions - score} </span> Inorrect</p>
          </div>
