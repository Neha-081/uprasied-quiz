...
const Quiz = ({ questions, totalQuestions }: Props) => {
  ...
  return (
    ...
    <Image className="h-[100px] w-full m-auto" src={HeaderImg} width={0} height={0} alt='nav' />
    {/* <div className='text-black bg-white text-center p-5 overflow-hidden rounded-t-lg'> */}
